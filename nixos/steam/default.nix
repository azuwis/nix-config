...

{
  options.programs.steam = {
    enhance = lib.mkEnableOption "and enhance steam";
    nvidia-offload = lib.mkEnableOption "nvidia-offload";
    gamescope-intel-fix = lib.mkEnableOption "gamescope-intel-fix";
    gamescope-git = lib.mkEnableOption "gamescope git";
  };
  ...
  config = lib.mkIf cfg.enhance (
    lib.mkMerge [
      ...
      (lib.mkIf cfg.gamescope-intel-fix {
