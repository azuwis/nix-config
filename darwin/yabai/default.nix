...

{
  options.services.yabai = {
    enhance = lib.mkEnableOption "and enhance yabai";
  };
  ...
  config = lib.mkIf cfg.enhance {
    ...
    services.yabai = {
      ...
      # https://github.com/asmvik/yabai/issues/1297#issuecomment-1318403190
    ...
    # https://github.com/asmvik/yabai#requirements-and-caveats
