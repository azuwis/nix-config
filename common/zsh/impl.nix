...

{
  ...
  config = lib.mkIf cfg.enable {
    ...
    wrappers.zsh.finalPackage = pkgs.wrapper {
      package = pkgs.zsh;
      env.ZDOTDIR = cfg.zdotdir;
    };

    wrappers.zsh.shellAliases = builtins.mapAttrs (name: lib.mkDefault) cfge.shellAliases;

    wrappers.zsh.zdotdir = pkgs.linkFarm "zsh-zdotdir" {
      ...
      ".zprofile" = pkgs.writeText "zsh-zprofile" ''
