{
  ...
  my = {
    lastModified = 1776321916;
    lastModifiedDate = "20260416064516";
    narHash = "sha256-OvEZOlgfl5fzbrPOg0IEhaQGBnbaf5FdigXMs1BjlHA=";
    outPath = "/nix/store/j03b1syx7qsrn949kwdprjvb0gkfvc54-source";
    rev = "8c89a9f5ba936bf0033fcd0899b1ac8609049f13";
    revCount = 0;
    shortRev = "8c89a9f";
    submodules = false;
  };
  ...
  nix-index-database = {
    lastModified = 1775365384;
    lastModifiedDate = "20260405050304";
    narHash = "sha256-tnUZVZd4pS8m4PET+w9teXHeXC8qnoXOoItB0JrLbwA=";
    outPath = "/nix/store/i9mzgymr08qsk1l9qr5hxzsc31yii1c9-source";
    rev = "c919750a34578b19b82389cd158d45f9bc9c90f5";
    revCount = 0;
    shortRev = "c919750";
    submodules = false;
  };
